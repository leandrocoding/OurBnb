...
export default function FiltersPage() {
  const { currentGroup, filters, setFilters } = useAppStore();
  
  const [priceMin, setPriceMin] = useState(filters.priceMin || 50);
  ...
  const [minBathrooms, setMinBathrooms] = useState(filters.minBathrooms || 0);
  const [roomType, setRoomType] = useState<RoomType | undefined>(filters.roomType);
  const [selectedAmenities, setSelectedAmenities] = useState<Amenity[]>(filters.amenities || []);
  ...
  return (
    <div className="bg-white h-full overflow-y-auto pb-32">
      <header className="bg-white px-6 py-4 flex items-center justify-between sticky top-0 z-50 border-b border-slate-100 shadow-sm">
         ...
         }} className="text-rose-500 font-medium text-sm">Reset</button>
      </header>
      ...
      <div className="p-6 flex flex-col gap-8">
          ...
          <div>
              ...
              <p className="mt-2 text-sm text-slate-400 px-2">Per night, per person</p>
          </div>
          ...
          <div>
               ...
               <div className="flex items-center justify-between mb-4">
                   ...
                   <div className="flex items-center gap-3">
                       ...
                       <span className="w-4 text-center text-slate-900">{minBedrooms || 'Any'}</span>
                       <button 
               ...
               <div className="flex items-center justify-between mb-4">
                   ...
                   <div className="flex items-center gap-3">
                       ...
                       <span className="w-4 text-center text-slate-900">{minBeds || 'Any'}</span>
                       <button 
               ...
               <div className="flex items-center justify-between">
                   ...
                   <div className="flex items-center gap-3">
                       ...
                       <span className="w-4 text-center text-slate-900">{minBathrooms || 'Any'}</span>
                       <button 
      ...
      <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-40">
           <Link href={`/group/${currentGroup?.id || 'g1'}`} onClick={handleSave} className="bg-rose-500 text-white px-8 py-3 rounded-full font-bold shadow-lg flex items-center gap-2 hover:bg-rose-600 transition-colors">
